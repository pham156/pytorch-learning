...
class PositionalEncoding(nn.Module):
    ...
    def __init__(self, embed_dim, dropout=0.1, max_len=5000):
        ...
        # power of 10000
        pows = torch.pow(10000, -torch.arange(0, embed_dim/2, 2) / embed_dim)
        # compute position embedding using sin/cos
...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, query, key, value, attn_mask=None):
        ...
        # mask Y so V cannot access with terms after this
        if attn_mask:
